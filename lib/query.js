 ...
 * to escape specials characters that are part of the query syntax of Lucene
 * and encode URI components
 */

querystring.escape = format.escapeAndEncode;
 ...
 * Applying this parameter forces the query type to be dismax.
 * 
 * @param {String|Number} slop - Amount of phrase slop allowed by the query filter. This value should represent the maximum number of words allowed between words in a field that match a phrase in the query.
 * 
 * @return {Query}
 * @api public
 */
 ...
 * Applying this parameter forces the query type to be dismax.
 * 
 * @param {String|Number} slop - Amount of query slop allowed by the query filter. This value should be used to affect boosting of query strings.
 * 
 * @return {Query}
 * @api public
 */
