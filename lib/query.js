...
/**
 * Set the maximun number of documents returned
 *
 ...
 * @param {String|Number|Date|Array} value - value of the field that must match
 * 
 * @return {Query}
 * @api public
 *
...
Query.prototype.matchFilter = function(field,value){
   ...
   if(Object.prototype.toString.apply(value) == '[object Array]') {
      value.forEach(function(v,i){
         value[i] = field + ':' + encodeURIComponent(v);
      });
      parameter += value.join('%20OR%20');
   }else{
