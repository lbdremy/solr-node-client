...
Client.prototype.createAddStream = function(options){
   var path = [this.options.path,this.options.core, this.UPDATE_HANDLER + '?' + querystring.stringify(options) +'&wt=json']
...
Client.prototype.update = function(data,options,callback){
   ...
   var fullPath = [this.options.path,this.options.core, this.UPDATE_HANDLER + '?' + querystring.stringify(options) +'&wt=json']
                              .filter(function(element){
                                 return element;
                              })
                              .join('/');
