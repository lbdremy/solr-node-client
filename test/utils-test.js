...
describe('type', function() {
	describe('isNumber, strict', function() {
		...
		it('should detect negatively a parameter that contains a mixed number or no number', function() {
			assert.equal(typeUtils.isNumber('1a'), false, '"- 1" is not a number (mixed number)');
	...
	describe('isNumber, non strict', function() {
		...
		it('should detect negatively a parameter that contains no valid number', function() {
			assert.equal(typeUtils.isNumber('1a', false), false, '"- 1" is not a number (mixed number)');
...
describe('array', function() {
	describe('toArray', function() {
		it('should array-ize everything', function() {
			assert.equals(Array.isArray(arrayUtils.toArray([])), true, '[] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray('')), true, '[""] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray([{a: 123}])), true, '[{a: 123}] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray([1])), true, '[1] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray(['a'])), true, '["a"] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray([0])), true, '[0] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray([-1])), true, '[-1] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray('')), true, '[""] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray(0)), true, '[0] is an array');
			assert.equals(Array.isArray(arrayUtils.toArray()), true, '[] is an array');
		...
		it('should handle null and undefined properly', function() {
			assert.equals(arrayUtils.toArray(undefined, '')[0] === '', true, 'undefined was cleaned up as empty string');
			assert.equals(arrayUtils.toArray(undefined)[0] === '', true, 'using the default setup, undefined was cleaned up as empty string');
			assert.equals(arrayUtils.toArray(null, '')[0] === '', true, 'null was cleaned up as empty string');
			assert.equals(arrayUtils.toArray(null)[0] === '', true, 'using the default setup, null was cleaned up as empty string');
		});
	});
});
