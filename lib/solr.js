...
function createClient(host, port, core, path, handler, agent, secure, bigint, solrVersion){
...
function Client(options){
   this.options = {
      ...
      handler : options.handler || 'select',
      agent : options.agent,
...
Client.prototype.search = function(query,callback){
   return this.get(this.options.handler, query, callback);
}
