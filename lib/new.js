...
function createClient(endpoints, core, path, agent, secure, bigint) {
...
function Client(options) {
  ...
  this.pool = new Pool(protocol, this.options.endpoints);
...
Client.prototype.postJSON = function(params, callback) {
  ...
  self.pool.request(options, params.json, function(err, response, body) {
    if (err) {
      ...
      handleJSONResponse(options, params.bigint, callback)(response, body);
    }
  });
};
...
function handleJSONResponse(request, bigint, callback) {
  return function onJSONResponse(response, body) {
    var err = null;
    var data = null;
