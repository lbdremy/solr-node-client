...
/**
 * Find all `Date` objects and format them into strings which can be understood
 * by Solr.
 *
 * @param {Array|Object} obj
 *   The array of object in which to search for date objects.
 *
 * @return {Array|Object}
 * @api private
 */
...
/**
 * Format a single `Date` object as a string which can be understood by Solr.
 *
