...
Client.prototype.extractStreamContents = function(stream,doc,options,callback){
   ...
   stream.pipe(this.createExtractStream(doc, options, callback));
}
...
Client.prototype.createExtractStream = function(doc, options, callback) {
   if (doc) {
   ...
   return new ExtractHelperStream(function(source){
