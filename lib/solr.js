...
Client.prototype.extractFileContents = function(file,fields,options,callback){
   var stream = fs.createReadStream(file);
   this.extractStreamContents(stream,fields,options,callback);
}
...
Client.prototype.extractStreamContents = function(stream,fields,options,callback){
   if(typeof(options) === 'function'){
      callback = options;
      options = {};
   }
...
Client.prototype.ping = function(callback){
   ...
   return this.get(this.ADMIN_PING_HANDLER, {"omitHeader": "true"}, callback);
}
...
var extractRequest = function(params,callback){
   ...
   form.append('my_file', params.stream);   
