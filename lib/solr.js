...
/**
 * Unauthentication of the client
 *
 * @return {Client Object}
 */
 ...
 * 
 * @param {Query} query - Query object create thanks to createQuery()
 * @param {Function} callback - Function to execute when the Solr Server responds or an error occurs
 *
 * @return {Client Object}
 */ 
...
Client.prototype.query = function(query,callback){
   var self = this;
   // TODO Be more flexible allow query to be a string and not only a Query object
