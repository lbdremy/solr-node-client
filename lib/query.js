 ...
 * @param {Array} [options.percentiles] - The list of all percentile values to be computed and returned in the stats result.
 *
 * @return {Query}
 * @api public
 */
Query.prototype.stats = function(options){
   ...
   if(options.percentiles){
      statsClause.push('percentiles=\'' + percentiles.join(',') + '\'');
   }
